...
export const INPUT_WIDTH: string = 'InputWidth';
export const MEDIA_QUERIES: string = 'MediaQueries';
export const OPEN_TRIGGER: string = 'OpenTrigger';
export const PORTAL: string = 'Portal';
export const TRANSITION_ACCORDION: string = 'TransitionAccordion';

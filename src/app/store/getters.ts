...
// export const getCategory: Getter<ModulState, ModulState> = (state: ModulState) => {
//     return state.category != undefined && Object.keys(this.selectedCategory).length > 0 ? state.category : undefined;
// };
